...
> **Version:** v1.2.1 | **Last Updated:** 2026-06-12 | **対象OS:** Windows 10 / 11
...
### 7-5. 「TesseractNotFoundError」

Tesseract-OCR が未インストールです。[2-1](#2-1-tesseract-ocr-のインストール)に従って導入してください。
